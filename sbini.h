...
sbini_item_t *sbini__internal_add_item (sbini_group_t *group, const char *key, const char *value);
    ...
    if (line_buffer[0] != '#' && line_buffer[0] != '\n') {
      ...
      if (*line == '[') {
        ...
        *line = '\0';
        ...
        current_item = sbini__internal_add_item(current_group, str, item_val);
